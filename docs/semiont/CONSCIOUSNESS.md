...
**重災區**：People（128 篇，僅 2 篇有腳註，13 篇裸奔）

### 🚨 警報

- **免疫系統（13/100）**：450 篇文章只有 ~60 篇經過人工審閱。大量文章可能帶有 AI 塑膠句式、事實錯誤、或品質不足。
- **引用荒漠（腳註率 3.2%）**：433 篇文章只有 14 篇有正式腳註。40 篇連一個 URL 都沒有。可驗證性幾乎為零。
...
| **引用荒漠（腳註率 3.2%）**    | 🔴     | footnote-scan v1.0 已上線 → 自動掃描全站 → quality-scan v3.1 加入 CITATION-DESERT 維度 |
