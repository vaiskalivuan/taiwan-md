...
| 📝 知識細胞（中文 SSOT） | 455 篇（+3 新文章 merged） |
| 🌐 英文細胞              | 402 篇                     |
| 🇪🇸 西文 / 🇯🇵 日文        | 46 / 24 篇                 |
| 📊 平均修訂次數          | 8 次/篇                    |
...
| 指標                | 數值                                        |
| ------------------- | ------------------------------------------- |
| 🟢 A 等級（優秀）   | 30 篇（6.9%）→ 金融科技 F→A + 3 新文章 A 級 |
| 🟢 B 等級（有腳註） | 6 篇（1.4%）                                |
| 🟡 C 等級（有URL）  | 341 篇（78.2%）                             |
| 🟡 D 等級（少URL）  | 27 篇（6.2%）                               |
| 🔴 F 等級（裸奔）   | 33 篇（7.6%）                               |
| 📊 腳註覆蓋率       | 36/437 = **8.2%**                           |
| 📊 裸奔率           | 33/437 = **7.6%**                           |

**最危險分類（腳註率 0%）**：About、Language、Lifestyle、Society（Economy 已破零：金融科技 16 腳註）

**重災區**：People（128 篇，僅 6 篇有腳註，10 篇裸奔）

### 🚨 警報

- **引用荒漠（腳註率 6.0%）**：432 篇文章只有 26 篇有正式腳註。35 篇連一個 URL 都沒有。可驗證性仍然很低。
- **format-check 51% fail**：220/433 篇文章 format-check 失敗，主要問題：no_reading 408（94%）、bad_fn_format 235、no_overview 158。
- **quality-scan 高度可疑 45%**：203/449 篇得分 ≥ 8，最差文章：澎湖民俗文化[14]、電子商務與數位支付[14]、台灣婚喪喜慶[14]、動物園與展演動物倫理[14]（台灣金融科技已從[14]降至[4]）。
